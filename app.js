...
console.log(isItPossible('000' + 'XXX' + 'XXX'));
...
function isItPossible(field) {
  ...
  if (field[0] === field[1] && field[1] === field[2] && field[0] != '_') {
    field[0] === '0' ? (victoryOfZero = true) : (victoryOfX = true);
    victory = true;
  } else if (
    field[3] === field[4] &&
    field[4] === field[5] &&
    ...
    victory = true;
    field[3] === '0' ? (victoryOfZero = true) : (victoryOfX = true);
  } else if (
    field[6] === field[7] &&
    field[7] === field[8] &&
    field[6] != '_'
    ...
    victory = true;
    field[6] === '0' ? (victoryOfZero = true) : (victoryOfX = true);
  } else if (
    field[0] === field[3] &&
    field[3] === field[6] &&
    field[0] != '_'
    ...
    victory = true;
    field[1] === '0' ? (victoryOfZero = true) : (victoryOfX = true);
  } else if (
    field[2] === field[5] &&
    field[5] === field[8] &&
    field[2] != '_'
    ...
    victory = true;
    field[2] === '0' ? (victoryOfZero = true) : (victoryOfX = true);
  } else if (
    field[0] === field[4] &&
    field[4] === field[8] &&
    field[0] != '_'
  ...
  console.log(`victoryOfZero -> ${victoryOfZero}`);
  console.log(`victoryOfX -> ${victoryOfX}`);
}
